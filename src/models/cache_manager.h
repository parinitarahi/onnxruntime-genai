...
class PagedCacheManager {
 public:
  ...
  //   [16, 17, 18, -1, -1]
  // ]
  // since sequence length will be decided by the max prompt token size in the batch.
  // Decoding stage:
  ...
  // void ReorderCache(const std::vector<size_t>& sequence_ids);
  ...
  */
  ...
  void FreeBlocks(const std::vector<size_t>& block_ids);
  ...
  std::vector<bool> available_blocks_;                                                  // List of free blocks
